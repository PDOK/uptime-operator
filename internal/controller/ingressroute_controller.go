...
// +kubebuilder:rbac:groups=traefik.io.pdok.nl,resources=ingressroutes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=traefik.io.pdok.nl,resources=ingressroutes/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=traefik.io.pdok.nl,resources=ingressroutes/finalizers,verbs=update
